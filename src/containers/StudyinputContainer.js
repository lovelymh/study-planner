...
const mapDispatchToProps = (dispatch) => ({
  onChange: (e, selectedid) => dispatch(actions.setstudyinput(e.target.value, selectedid)),
  onChangetopic: (e, selectedid) => dispatch(actions.setstudytopic(e.target.value, selectedid)),
