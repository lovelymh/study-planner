...
const Studyinputform = ({ selectedid, seqid, subject, data, studylist,
  ...
  return(
    <div className="study-input-form">
      <input className="input topic" type="text" onChange={(e)=>onChangetopic(e)} value={subject}/>
      <input className="input content" type="text" onChange={(e)=>onChange(e)} value={data}/>
